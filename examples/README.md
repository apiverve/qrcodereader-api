# QR Code Reader API - Examples

This folder contains example code for using the QR Code Reader API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/qrcodereader',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/qrcodereader");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/qrcodereader](https://docs.apiverve.com/ref/qrcodereader)
