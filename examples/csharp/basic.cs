...
namespace APIVerve.Examples
{
    class QRCodeReaderExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/qrcodereader";

        /// <summary>
        /// Make a GET request to the QR Code Reader API
        /// </summary>
        static async Task<JsonDocument> CallQRCodeReaderAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling QR Code Reader API...\n");

            var result = await CallQRCodeReaderAPI();
