...
namespace APIVerve.API.QRCodeReader
{
    ...
    /// <summary>
    /// Client for the QRCodeReader API
    /// </summary>
    public class QRCodeReaderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/qrcodereader";
        ...
        {
            { "image", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public QRCodeReaderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public QRCodeReaderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public QRCodeReaderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, QRCodeReaderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(QRCodeReaderQueryOptions options)
        {
        ...
        public ResponseObj Execute(QRCodeReaderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(QRCodeReaderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(QRCodeReaderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(QRCodeReaderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(QRCodeReaderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(QRCodeReaderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(QRCodeReaderQueryOptions options)
        {
