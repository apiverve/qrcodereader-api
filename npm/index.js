...
class qrcodereaderWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/qrcodereader');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/qrcodereader';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"image":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/qrcodereader`);
        }
    }
    ...
    async executeWithFile(file, options = {}, callback) {
        ...
        if (!file) {
            throw new Error('File must be provided for file upload. See documentation: https://docs.apiverve.com/ref/qrcodereader');
        }
        ...
        if (typeof file === 'string') {
            ...
            throw new Error('File must be a file path (string), Buffer, or ReadStream. See documentation: https://docs.apiverve.com/ref/qrcodereader');
        }
    ...
    async executeWithUrl(url, options = {}, callback) {
        ...
        if (!url || typeof url !== 'string') {
            throw new Error('URL must be provided as a string. See documentation: https://docs.apiverve.com/ref/qrcodereader');
        }
...
module.exports = qrcodereaderWrapper;
