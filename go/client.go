...
const (
	baseURL        = "https://api.apiverve.com/v1/qrcodereader"
	defaultTimeout = 30 * time.Second
)

// Client is the QR Code Reader API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new QR Code Reader API client.
...
// ExecuteWithFile makes a request to the QR Code Reader API with a file upload.
...
// Execute makes a request to the QR Code Reader API with typed parameters.
//
