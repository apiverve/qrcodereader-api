// Package qrcodereader provides a Go client for the QR Code Reader API.
//
// For more information, visit: https://qrcodereader.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the QR Code Reader API.
//
// Parameters:
//   - image: string - Upload an image file containing a QR code to decode (supported formats: JPG, PNG, GIF)
type Request struct {
...
// ResponseData contains the data returned by the QR Code Reader API.
...
type LocationData struct {
	TopLeft TopLeftData `json:"topLeft"`
	TopRight TopRightData `json:"topRight"`
	BottomLeft BottomLeftData `json:"bottomLeft"`
	BottomRight BottomRightData `json:"bottomRight"`
}

// TopLeftData represents the topLeft object.
type TopLeftData struct {
	X float64 `json:"x"`
	Y float64 `json:"y"`
}

// TopRightData represents the topRight object.
type TopRightData struct {
	X float64 `json:"x"`
	Y float64 `json:"y"`
}

// BottomLeftData represents the bottomLeft object.
type BottomLeftData struct {
	X float64 `json:"x"`
	Y float64 `json:"y"`
}

// BottomRightData represents the bottomRight object.
type BottomRightData struct {
	X float64 `json:"x"`
	Y float64 `json:"y"`
}
